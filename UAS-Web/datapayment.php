                ...
                <tbody>
                  ...
                  if ($result && mysqli_num_rows($result) > 0) {
                    ...
                    while ($data = mysqli_fetch_assoc($result)) {
                      ?>
                      <tr>
                        <td><input type="checkbox" class="mt-1 checkbox" value="<?php echo $data['id_payment'] ?>">
                        <td>
                          <?php echo $no ?>
                        </td>
                        <td>
                        ...
                        <td>
                          <?php echo $data['tanggal_payment'] ?>
                        </td>
                        <td>
                          <?php echo $data['time_payment'] ?>
                        </td>
                        <td>
                        ...
                        <td>
                          <?php if ($data['file'] != null): ?>
                            <a href="crud/api.php?action=download&id_payment=<?= $data['id_payment'] ?>"
